...
export class CityViewUtil {
  ...
  public static getCityGridColumnList(cellTemplates: TemplateRef<any>[]): TableColumn[] {
    let columnList = [
        {
          prop: 'action', name: 'Action', width: 10, minWidth: 50, cellTemplate: cellTemplates[0], cellClass: '',
          headerTemplate: '', frozenLeft: true, sortable: false, resizeable: false
       },
        {
            prop: 'cityName', name: 'City Name', width: 150, minWidth: 70, cellTemplate: '', cellClass: '',
            headerTemplate: '', frozenLeft: false, resizeable: true
        },
        {
            prop: 'country', name: 'Country', width: 150, minWidth: 70, cellTemplate: '', cellClass: '',
            headerTemplate: '', frozenLeft: false, resizeable: true
        },
        {
            prop: 'cityDescription', name: 'Description', width: 150, minWidth: 70, cellTemplate: '', cellClass: '',
            headerTemplate: '', frozenLeft: false, resizeable: true
        },
        {
            prop: 'latitude', name: 'Latitude', width: 80, minWidth: 70, cellTemplate: '', cellClass: '',
            headerTemplate: '', frozenLeft: false, resizeable: false
        },
        {
            prop: 'longitude', name: 'Longitude', width: 100, minWidth: 70, cellTemplate: '', cellClass: '',
            headerTemplate: '', frozenLeft: false,  resizeable: false
        }
